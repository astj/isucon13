...
CREATE TABLE `livestreams` (
  ...
  KEY `livestreams_user_id` (`user_id`)
) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE TABLE `reservation_slots` (
  ...
  `start_at` BIGINT NOT NULL,
  `end_at` BIGINT NOT NULL,
  KEY `reservation_slots_start_at_end_at` (`start_at`, `end_at`)
) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE TABLE `livecomments` (
  ...
  `created_at` BIGINT NOT NULL,
  KEY `livecomments_livestream_id` (`livestream_id`)
) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE TABLE `ng_words` (
  ...
  `created_at` BIGINT NOT NULL,
  KEY `ng_words_user_id_livestream_id` (`user_id`, `livestream_id`)
) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE TABLE `reactions` (
  ...
  `created_at` BIGINT NOT NULL,
  KEY `reactions_livestream_id` (`livestream_id`)
) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
